...
<xsl:template match="explore | explanation | introduction | theory | application | extra |test | summary | exam | examples" mode="collect">
    
</xsl:template>

<xsl:template match="digest" mode="collect">
    <xsl:param name="path"/>
