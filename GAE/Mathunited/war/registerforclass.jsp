...
<%
   	...
   	if (request.getParameter("postback") != null)
	{
    	...
    	{    	
	    	...
	    	response.sendRedirect("/viewclasses.jsp?userid=" + userid + "&repo=" + repo + "&threadid=" + threadid + "&added=" + selectedClassId);
    	}
	}
%>
...
<form method="post" action="/registerforclass.jsp?userid=<%= user.id %>&repo=<%= repo %>&threadid=<%= threadid %>" id="form">
