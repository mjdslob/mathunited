...
<div class="sectionDiv">
   <div class="balk">
       <xsl:call-template name="list-section-nrs">
           ...
           <xsl:with-param name="subcomponents" select="$parsed_component/component/subcomponents"/>
       </xsl:call-template>
            ...
            <span class="list-section-nr">
                <a>
                    <xsl:attribute name="href">
                       <xsl:value-of select="concat('view?comp=',$comp,'&amp;subcomp=',$subcomponents/subcomponent[number(@number)=number($i)]/@id,'&amp;variant=',$variant,$arg_parent,$arg_repo)"/>
                    </xsl:attribute>
