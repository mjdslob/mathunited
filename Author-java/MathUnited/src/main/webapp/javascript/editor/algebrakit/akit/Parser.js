...
define(['jquery'], function ($) {
    return {
        parse: function (xml, parent, thisStepId, nextStepId) {
            ...
            if (nextStepId > 0 || thisStepId > 0)
                this.highlight(xml, thisStepId, nextStepId);
            ...
            if (elms && elms.length > 0) {
                ...
                for (var ii = 0; ii < elms.length; ii++) {
                    ...
                    loadScript(elms[ii], function () {
                        thisInstance.continueParsing();
                    });
                }
            } else {
        ...
        parseFromHTML: function (htmlstr, parent) {
            ...
            //call script functions that may be defined
            $('.loadScript', parent).each(function(){
                var elm = $(this);
            });
