...
define(['jquery', 'akitex/Exercise','org/mathdox'], function($, Exercise, MathDox) {
    org.mathdox.formulaeditor.options.paletteShow = 'none';
    org.mathdox.formulaeditor.options.decimalMark = ',';
