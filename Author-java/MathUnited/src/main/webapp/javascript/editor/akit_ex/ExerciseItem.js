            ...
            submitInput: function(inputStr) {
                ...
                function callback(result) {
                    ...
                    if (result.correct) {
                        ...
                        if (result.done) {
                            var v = null;
                            _this.archiveInputField({exp:inputStr, correct:true, done:true});
                            ...
                            _this.archiveInputField({exp:inputStr, correct:true, done:false});
                        ...
                        _this.archiveInputField({exp:inputStr, correct:false, buggyDerivation: result.buggyDerivation});
                        _this.clearInputField();
                    }
                }
