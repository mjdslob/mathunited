...
//    var engineUrl = '/AKITServer/Main';
    ...
    return {
        ...
        getSolutionModelFromExpr: function (spec) {
            ...
            if(spec.attributes) params+='&tags='+spec.attributes;
            if(spec.akitVersion) params+='&akit-version='+spec.akitVersion;
            if(spec.variables) params+='&variables='+encodeURIComponent(variablesToString(spec.variables));
            var url = engineUrl;
