...
define(["require", "jquery"], function (require, $) {
    ...
    function Cell(spec) {
        ...
        if (spec.parent)
            domParent = spec.parent.getContainer_jq();
        var nestingLevel = 0;
        if (spec.parent)
            nestingLevel = spec.parent.nestingLevel + 1;
        if (spec.key === undefined)
            spec.key = spec.solutionCell.key;
        ...
        var _obj = {
            ...
            init: function () {
                ...
                if (!this.key || this.key.length <= 1)
                    $('.akit-cell-placeholder', this.dom).remove();
                var keyStr = '';
            ...
            getContainer_jq: function () {
                return cellContainer_jq;
            },
            ...
            addInput: function (inputMML, inputLatex, inputAKIT, resultType) {
                ...
                switch (resultType) {
                    ...
                    case 'FINISHED':
                        ...
                        break;
                    default:
                        $('.akit-result-icon', elm)[0].className = 'akit-result-icon akit-icon-correct';
                        if (inputAKIT)
                            this.lead = inputAKIT;
                        break;
                }
            ...
            isVirgin: function () {
                return cellContainer_jq.children('.akit-input-elm').length === 0;
            },
            ...
            setHint: function (spec) {
                ...
                var container;
                if (spec.wkhint && spec.wkhint.type === 'step')
                    container = footerContainer_jq;
                else
                    container = headerContainer_jq;
