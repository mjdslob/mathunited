...
<xsl:variable name="variant">m4a_view_dedicon</xsl:variable>
...
<xsl:include href="mathml/dedicon-math.xslt"/>

<xsl:template match="m:math" mode="content">
    <xsl:apply-templates select="." mode="mathml-dedicon"/>
</xsl:template>
