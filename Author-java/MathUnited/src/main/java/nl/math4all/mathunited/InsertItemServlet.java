...
public class InsertItemServlet extends HttpServlet {
    private String resultXML = "<insert result=\"{#RESULT}\"><message>{#MESSAGE}</message></insert>";
    XSLTbean processor;
    ...
    public void doPost ( HttpServletRequest request,
        ...
        try{
            ...
            String expression = "//include[contains(@filename,'*')]";
            ...
            for(int ii=0; ii<n; ii++) {
                ...
                if(nodeMap!=null) {
                    ...
                    if(attrNode!=null && child!=null) {
                        String fileStr = attrNode.getNodeValue();
                        fileStr = createValidFilename(attrNode.getNodeValue(), refbase, altbase);
                        FileManager.writeToFile(altbase+fileStr, child, repository);
                        node.removeChild(child);
                        attrNode.setNodeValue(fileStr);
                    }
                }
            }
