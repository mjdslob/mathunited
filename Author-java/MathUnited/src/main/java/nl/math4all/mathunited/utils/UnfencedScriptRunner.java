 ...
 */
public class UnfencedScriptRunner {
    static final Logger LOGGER = Logger.getLogger(UnfencedScriptRunner.class.getName());
     ...
     */
    public UnfencedScriptRunner(Writer writer) {
        this.writer = writer;
        makeStream();
    }
    ...
    public void runScript(String name, boolean exceptions, String... args) throws SvnException {
        ...
        URL scriptURL = UnfencedScriptRunner.class.getResource("/" + escapedName + ".zsh");
        if (scriptURL == null) {
