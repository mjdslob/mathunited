...
(function($) {
    ...
    $.fn.fixedTable = function(opts) {
        ...
        $("." + options.classColumn + " > .fixedTable", layout).css({
            "width": (options.fixedColumnWidth - 2) + "px",
            "overflow": "hidden",
    ...
    function adjustSizes(options) {
        ...
        $("#" + Id + " .fixedContainer ." + options.classHeader + " table tr:first td").each(function(pos) {
            totall += options.columnWidth + 8;
        });
        totall += 2;

        $("#" + Id + " .fixedContainer ." + options.classHeader + " table").width(totall);
        $("#" + Id + " .fixedContainer .fixedTable table").width(totall);
        $("#" + Id + " .fixedContainer ." + options.classFooter + " table").width(totall);
        $("#" + Id + " .fixedContainer ." + options.classHeader + " table tr td").each(function(j) {
            $(this).attr("width", options.columnWidth + "px");
        });
